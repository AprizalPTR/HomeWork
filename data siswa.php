...
<div class="main-container d-flex">
        <div class="sidebar" id="side_nav">
            ...
            <ul class="list-unstyled px-2">
                <li class=""><a href="user.php" class="text-decoration-none px-3 py-2 d-block"><i
                            ...
                            <li class="active"><a href="data siswa.php" class="text-decoration-none px-3 py-2 d-block"><i
  ...
  <br>
    ...
    if(isset($_POST['cari'])) {
      $keyword = $_POST ['cari1'];
      $q = "SELECT * FROM siswa where NISN like '$keyword%' or Nama like '$keyword%' order by Nama asc";
    } else {
